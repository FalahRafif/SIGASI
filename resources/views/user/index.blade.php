                ...
                <table id="dataTable" class="table table-bordered " cellspacing="1"><br />
                    ...
                    <tbody>
                        @foreach ($user as $index => $userItem)
                            ...
                            <!-- Modal Tambah User -->
                            <div class="modal fade text-dark" id="addUserModal" tabindex="-1" role="dialog"
                                ...
                                @enderror --}}
                                                ...
                                                <div class="row mb-3">
                                                    <label for="email" class="col-md-4 col-form-label text-md-end">Alamat
                                                        Email</label>
                                ...
                                @enderror --}}
                                                ...
                                                <div class="row mb-3">
                                                    <label for="password-confirm"
                                                        class="col-md-4 col-form-label text-md-end">Konfirmasi</label>
